...
<div class="pagination">
	<button on:click={handlePrev}><span class="icon"><SwiperPrev /></span>Previous</button>
	...
	{#if endPage < totalPages}
		...
		>
	{/if}
	<button on:click={handleNext}>Next<span class="icon"><SwiperNext /></span></button>
</div>
